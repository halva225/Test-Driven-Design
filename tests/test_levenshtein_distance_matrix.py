...
class levenshtein_Distance_Matrix_test:
    ...
    def test_levenshtein_distance_matrix_with_0_columns_returns_fail():
        # test init
        rows = 0
        cols = 0
        distances = numpy.zeros((rows + 1, cols + 1))
...
print(levenshtein_Distance_Matrix_test.test_levenshtein_distance_matrix_with_0_columns_returns_fail())